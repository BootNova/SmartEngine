package com.bootnova.smart.framework.engine.extension.scanner;
...
public class SimpleAnnotationScannerTest {
    ...
    @Test
    public void scan() {
        SimpleAnnotationScanner simpleAnnotationScanner = new SimpleAnnotationScanner("com.bootnova.smart.framework.engine.extension.scanner");
