...
@Transactional
public class ConcurrentParallelGatewayDBWithTenantIdTest extends DatabaseBaseTestCase {
    ...
    public void testReceiveTaskParallelGateway() throws Exception {
        ...
        ProcessDefinition processDefinition = repositoryCommandService
            .deploy("test-receivetask-parallel-gateway.bpmn20.xml",tenantId).getFirstProcessDefinition();
        ...
        List<ExecutionInstance> executionInstanceList = executionQueryService.findActiveExecutionList(
            processInstance.getInstanceId(),processInstance.getTenantId());
