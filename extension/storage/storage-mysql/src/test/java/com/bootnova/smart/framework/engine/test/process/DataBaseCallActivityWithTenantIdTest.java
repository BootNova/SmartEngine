...
@Transactional
public class DataBaseCallActivityWithTenantIdTest extends DatabaseBaseTestCase {
    ...
    public void testBasicCallActivityWhenChildProcessIsPaused()  {
        ...
        List<ExecutionInstance> childExecutionInstanceList = executionQueryService.findActiveExecutionList(childProcessInstanceId,tenantId);
        ...
        //断言子流程结束
        ProcessInstance subProcessInstance = processQueryService.findById(childProcessInstanceId,tenantId);
        Assert.assertEquals(InstanceStatus.completed, subProcessInstance.getStatus());
        List<ExecutionInstance> childExecutionInstanceList4 = executionQueryService.findActiveExecutionList(childProcessInstanceId,tenantId);
    ...
    private ExecutionInstance findAndAssertAtPreOrderPhase(ProcessInstance oldProcessInstance) {
        ...
        ProcessInstance parentProcessInstance = processQueryService.findById(oldProcessInstance.getInstanceId(),oldProcessInstance.getTenantId());
    ...
    private class ProduceProcessInstanceIds {
        ...
        public ProduceProcessInstanceIds invoke() {
            ...
            ProcessDefinition parentProcessDefinition = repositoryCommandService
                .deploy("parent-callactivity-process.bpmn20.xml",tenantId).getFirstProcessDefinition();
            ...
            ProcessDefinition childProcessDefinition = repositoryCommandService
                .deploy("child-callactivity-process.bpmn20.xml",tenantId).getFirstProcessDefinition();
