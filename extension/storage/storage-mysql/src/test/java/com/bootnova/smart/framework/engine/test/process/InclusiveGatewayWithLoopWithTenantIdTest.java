...
@Transactional
public class InclusiveGatewayWithLoopWithTenantIdTest extends DatabaseBaseTestCase {
    ...
    public void testInclusiveGatewayWithLoop() {
        ...
        ProcessDefinition processDefinition = repositoryCommandService
            .deploy("database/InclusiveGatewayWithLoopTest.xml",tenantId).getFirstProcessDefinition();
