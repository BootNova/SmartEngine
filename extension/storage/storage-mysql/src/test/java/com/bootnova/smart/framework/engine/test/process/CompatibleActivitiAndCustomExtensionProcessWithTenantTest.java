...
import com.bootnova.smart.framework.engine.test.process.bean.Order;
...
@Transactional
public class CompatibleActivitiAndCustomExtensionProcessWithTenantTest extends DatabaseBaseTestCase {
    ...
    public void testMultiInstance() throws Exception {
        ...
        List<TaskInstance>  assertedTaskInstanceList=   taskQueryService.findAllPendingTaskList(processInstance.getInstanceId(),processInstance.getTenantId());
        ...
        activeExecutions = executionQueryService.findActiveExecutionList(processInstance.getInstanceId(),processInstance.getTenantId());
