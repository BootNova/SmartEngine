...
@Transactional
public class ParalleyGatewayAndCallActivityTest extends DatabaseBaseTestCase {
    ...
    private class ProduceProcessInstanceIds {
        ...
        public ProduceProcessInstanceIds invoke() {
            ...
            ProcessDefinition parentProcessDefinition = repositoryCommandService
                .deploy("complex/parent-callactivity-process.bpmn20.xml").getFirstProcessDefinition();
            ...
            ProcessDefinition bChildProcessDefinition = repositoryCommandService
                .deploy("complex/child-serviceTaskCallActivity.bpmn20.xml").getFirstProcessDefinition();
            ...
            ProcessDefinition aChildProcessDefinition = repositoryCommandService
                .deploy("complex/child-receiveTaskCallActivity.bpmn20.xml").getFirstProcessDefinition();
