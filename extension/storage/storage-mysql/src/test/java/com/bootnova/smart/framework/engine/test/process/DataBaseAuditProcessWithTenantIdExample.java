...
@Transactional
public class DataBaseAuditProcessWithTenantIdExample extends DatabaseBaseTestCase {
    ...
    private void assertTransferAPI(TaskInstance auditTaskInstance) {
        taskCommandService.transfer(auditTaskInstance.getInstanceId(),"3","4",auditTaskInstance.getTenantId());
        List<TaskAssigneeInstance> list = taskAssigneeQueryService.findList(auditTaskInstance.getInstanceId(),auditTaskInstance.getTenantId());
